...
- (void)setUp
{
  ...
  FBSimulator *simulator = [[FBSimulator alloc] initWithDevice:(id)device configuration:nil set:nil query:nil auxillaryDirectory:NSTemporaryDirectory() logger:nil];
